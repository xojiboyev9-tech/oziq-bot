...
async def add_product_description(message: Message, state: FSMContext):
    ...
    await message.answer(
        "Mahsulot rasmi uchun havola (link) yuboring (yoki - yozing, rasm bo'lmasa):\n\n"
        "Maslahat: rasmni https://imgbb.com saytiga yuklab, u yerdan to'g'ridan-to'g'ri "
        "havolani (direct link) oling."
    )
