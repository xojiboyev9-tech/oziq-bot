...
async def _run_polling_forever():
    """dp.start_polling birror xatolik tufayli to'xtab qolsa (masalan, vaqtinchalik
    internet/Telegram xatosi), buni jimgina o'lib qolishiga yo'l qo'ymaymiz -
    xatoni logga yozib, 5 soniyadan keyin qayta urinamiz."""
    while True:
        try:
            await dp.start_polling(bot)
        except Exception as e:
            logger.exception(f"Polling xato bilan tugadi: {e}. 5 soniyadan keyin qayta urinamiz
